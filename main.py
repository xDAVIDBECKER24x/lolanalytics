    ...
    with open(save_file, "w") as outfile:
        ...
        for match in match_list:
            ...
            if (check_match_settings(match, match_settings) == True):
                ...
                # match_creation = datetime.utcfromtimestamp(match_creation).strftime('%d-%m-%Y')
...
player_name = 'aegis'
path = player_type + '/'+player_name+'/'

raw_data_matchs_file = path + 'matchs_metadata_'+player_name+'.json'
...
puuid_robo = '1MIvsxWx7kzD6qK7Tk8aAH908L59S2BxS1vL6K6fKjGOcSUhdgE4MUdFMm51Srw84ZU171DkJ016wg'
puuid_redbert = 'EZYRE4MGGQgqQGo8wrKd0nbGsCb8mWNc7Pp0S6VLWyz6ipePiFcn6tqfAYDQkOBIvl8-gkW1rFmkuw'
puuid_aegis = '-AdfEz26CdEDewsjoPa5Th8SQXtbh3rP672IKoMDMO_-POgjXi_Pje2yIZrx8j2nGfuQeq13jVeDpQ'
puuid_ceos = 'yJJ-Tv5ruDm6r_u21LBVcZtfwe9MCtB7EYHLLNR8rZdUPkYSeDfryUwcraSxXxltAzolx2z5qrtUfg'
puuid_cariok = 'KywiMYSX0-Fui38aiX34d18pyayDw_81CWE4qsa-GW7hBZQWQjdR9XRmor448qpDmnsACq1vELB-lQ'

save_file = path + "ping_overview_"+player_name+".json"
...
save_pings_overview(raw_matches_data, match_settings, puuid_aegis, save_file)
